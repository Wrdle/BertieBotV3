...
@app.route('/uploadFont', methods=['POST'])
...
def publicLeaderboardPage():
    ...
    fontName = configFunctions.getPublicLeaderboardFont()
    if fontName == None:    
        fontName = "aurora.ttf"

    return render_template("publicleaderboard.html", client = client, guild = guild, leaderboard = leaderboard, autoRanks = autoRanks, fontName = fontName)
